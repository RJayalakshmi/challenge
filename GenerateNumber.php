...
// Returns the $name combined with random number between 6 and 15. Ex. "Rahul 11" if $name = 'Rahul'
...
if(!empty($name=  filter_input(INPUT_GET,'name'))){
    echo GenerateNumber($name);
}else{
    echo "Warning: please add get parameter 'name' in URL. EX: GenerateNumber.php?name=Rahul";
}
?>